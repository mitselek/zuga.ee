...
- url: /images/etendused-meelekolu-2.jpg
  width: 2048
  description: Tantsijad laval
- url: /images/etendused-meelekolu-3.jpg
  width: 1365
  description: Etenduse stseen
- url: /images/etendused-meelekolu-4.jpg
  width: 1364
  description: Tantsijad tegevuses
- url: /images/etendused-meelekolu-5.jpg
  width: 1366
  description: Lavastuse moment
...
*"Ei ole just kerge köita energiast pulbitsevaid lapsi ja leida teemasid, mis neid tõesti puudutavad. Ometi Zuga suutis seda"* Evelin Lagle, Sirp

*"meeleKolu" aitab täiskasvanud vaatajal oma aistingutega sügavamasse kontakti astuda, andes kätte kaardi, miks me oleme just sellised nagu oleme ja kust see alguse sai. See on nagu peegli asetamine näo ette, mis toob korraga selguse, kust see kõik tuleb, mida ma tunnen. Lapsepõlvest, ütleb Zuga. Ja neil on õigus.* Merilin Pärli, ERR

## Luuletus

*Ühes valges-valges saalis on üks valge kriuksuv uks*
*Selle valge kriuksuva ukse taga pimestab vaimustav valgus*
*Selles pimestav-vaimustavas valguses seisab nurgas nagisev nagi*
*Selles nagisevas nagis ripub üks kotti topitud tagi*
*Tagi taskupõhja on peidetud üksik hirmunud legopätt*
*Kellele roosa taskurätik lahkelt ulatab kätt*
*Maas rullib rõõmsalt end lahti valge ning vajalik vaip*
*Vaiba alla on peitu pugenud lodev ja logelev laip*
*Lendab lae alla õhetav ja õnnest õhkav õhupall*
*Tal täitunud on soov jääda hõljuma üleval*

## Lavastusest

Lastelavastuses "meeleKolu" kostitatakse publikut Zugakatele omase sooja vastuvõtu ja sõbraliku õhkkonnaga, lennukate ideede ja nutikalt kujundlike lahendustega ning valitud vanuserühma tabavalt puudutavate teemadega.

Lavastuse teemaks on meeleolu: erisugused meeleolud ja nende vaheldumine, kuidas oma meeleolu väljendada, kuidas kaaslaste meeleolust osa saada – teema, mis on tähtis east sõltumata. Meeleolusid antakse edasi mitmesuguste väljendusvahendite­ga: liikumise, sõna ja valgus­mängu abil.

Lavastus on väga tugev visuaalselt – erilaadseid väljendusvahendeid on kasutatud maitsekalt ning liikumine, sõna, valgusmängud (varjud seintel, pimedas helendav kummivõrgustik, seintele projitseeritud ruudustik) sulanduvad tervikuks.

Etenduse lõpus võetakse publik Zugale omaselt enda seltsi ning lastakse viimaks ometi sellesse ahvatlevasse seltskonda kuuluda. Ühiselt väljendatakse kehaga emotsioone ja joonistakse tundeid väikestele pallidele.

## Lavastusmeeskond

**Autorid ja esitajad:** Helen Reitsnik, Kärt Tõnisson, Tiina Mölder, Triin Lilleorg, Ajjar Ausma ja Päär Pärenson
**Helikujundaja:** Kalle Tikas
**Kunstnik:** Keili Retter
**Valguskunstnik:** Oliver Kulpsoo

**Esietendus:** 15. oktoober 2016, Sõltumatu Tantsu Lava
...
*"Õpetab lastele mängima nutitelefonide ajastul."* (etendusel käinud õpetaja)

*"Mulle väga meeldis. Eriti meeldis kui ma sain ise osaleda!"* (etendusel käinud laps)

## Arvustused ja kajastused

- [Meeleline tunnike Zuga seltsis](https://www.sirp.ee/meeleline-tunnike-zuga-seltsis/), Sirp, Evelin Lagle, 4. november 2016
