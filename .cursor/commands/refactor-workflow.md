---
description: Systematic refactoring workflow for Content Architecture Refactoring project - execute GitHub issues methodically with validation, documentation, and integration
---

# Refactoring Workflow - Content Architecture Refactoring
...
User: "/refactor-workflow proceed with #31"
...
```bash
# Invoke the command with issue number or "next issue"
/refactor-workflow Issue #30

# Or let it select the next available issue
/refactor-workflow next issue
```
